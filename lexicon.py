LEXICON: dict[str, str] = {
    ...
    '/start': '<b>Привет, читатель!</b>\n\nЭто бот, в котором '
              'ты можешь прочитать Рэя Брэдбери "Марсианские '
              'хроники" и многие другие известные книги\n\nЧтобы посмотреть список доступных '
              'команд - набери /help',
    '/help': '<b>Это бот-читалка</b>\n\nДоступные команды:\n\n'
             '/authors - выбрать желаемую книгу\n\n/beginning - '
    ...
    '/authors': '<b>Выбери книги авторов, которые хочеться прочитать.</b>',
    '/bookmarks': '<b>Это список ваших закладок:</b>',
    'edit_bookmarks': '<b>Редактировать закладки</b>',
    'edit_bookmarks_button': '❌ РЕДАКТИРОВАТЬ',
    'del': '❌',
    'cancel': 'ОТМЕНИТЬ',
    'succesfully_choice': 'Вы успешно выбрали книгу.',
    'continue_without_reading': 'Вы ещё не начинали читать :/',
